  ...
  head: () => ({
    meta: [
      { title: "OATF 2026 — Namibia's Largest Business & Culture Experience" },
      {
        name: "description",
        content:
          "Join 200,000+ visitors at the Ongwediva Annual Trade Fair 2026. Explore exhibitors, hall maps, schedule, travel and stay in northern Namibia.",
      },
      { property: "og:title", content: "OATF 2026 — Namibia's Largest Trade & Innovation Fair" },
      {
        property: "og:description",
        content: "Aug 28 – Sep 5, 2026. Discover exhibitors, products and experiences.",
      },
    ],
  }),
  component: HomePage,
...
const HALLS = [
  { name: "Innovation Hall", count: "120+ exhibitors", tone: "from-primary/30 to-transparent" },
  { name: "Agribusiness", count: "85+ exhibitors", tone: "from-oatf-blue/30 to-transparent" },
  { name: "Finance & Tech", count: "60+ exhibitors", tone: "from-oatf-gold/30 to-transparent" },
  { name: "Culture & Craft", count: "140+ exhibitors", tone: "from-primary/30 to-transparent" },
];
...
const STEPS = [
  { icon: Users, title: "Register", text: "Create your free OATF profile in 60 seconds." },
  {
    icon: MapPin,
    title: "Explore",
    text: "Navigate halls, exhibitors and stands on the live map.",
  },
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center pt-24">
        ...
        <div className="container-x relative z-10 py-20">
          <div className="max-w-4xl">
            ...
            <h1
              className="font-display text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.02] animate-fade-up"
              style={{ animationDelay: "0.1s" }}
            >
              Where Namibia
              <br />
              <span className="text-gradient-brand">does business.</span>
            </h1>
            <p
              className="mt-8 max-w-2xl text-lg md:text-xl text-muted-foreground leading-relaxed animate-fade-up"
              style={{ animationDelay: "0.2s" }}
            >
              Over 200 Exhibitors from various industries. Interactive sessions with 30+ Speakers. Networking opportunities and special promotions. The Ongwediva Annual Trade Fair is the heartbeat of trade, innovation and culture in northern Namibia.
            </p>
            <div
            ...
            >
              <Link
                to="/register"
                className="group inline-flex items-center gap-2 px-7 py-4 rounded-full bg-gradient-brand text-primary-foreground font-semibold shadow-elegant hover:scale-105 transition-transform"
              >
                Register for free
              ...
              <Link
                to="/explore"
                className="inline-flex items-center gap-2 px-7 py-4 rounded-full glass font-semibold hover:bg-white/10 transition-colors"
              >
      ...
      <section className="container-x py-24 md:py-32">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
          <StatCounter value={100} suffix="K+" label="Visitors" />
          <StatCounter value={450} suffix="+" label="Local & Int. Exhibitors" />
          <StatCounter value={30} suffix="+" label="Speakers" />
          ...
          <div className="grid lg:grid-cols-12 gap-6">
            <div className="lg:col-span-7 relative rounded-3xl overflow-hidden group shadow-elegant min-h-[420px]">
              ...
              <div className="relative p-10 h-full flex flex-col justify-end">
                <Building2 className="h-7 w-7 text-primary mb-4" />
                ...
                <p className="text-muted-foreground mt-3 max-w-md">
                  Tech startups, fintech, telecoms and the future of Namibian enterprise — all under
                  one roof.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 grid gap-6">
              {HALLS.map((h) => (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${h.tone} opacity-0 group-hover:opacity-100 transition-opacity`}
                  />
      ...
      <section className="container-x py-24 md:py-32">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="text-xs uppercase tracking-[0.3em] text-primary mb-3">How OATF Works</div>
          <h2 className="font-display text-4xl md:text-6xl font-bold leading-[1.05]">
            Engage. Earn. <span className="text-gradient-brand">Win.</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {STEPS.map((s, i) => (
            <div
              key={s.title}
              className="group relative glass rounded-2xl p-7 hover:-translate-y-1 transition-transform"
            >
              <div className="absolute top-5 right-5 text-xs font-mono text-muted-foreground/40">
                0{i + 1}
              </div>
        ...
        <div className="container-x">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative rounded-3xl overflow-hidden shadow-elegant">
              <img
                src={townImg}
                alt="Ongwediva town aerial view"
              ...
              <div className="absolute bottom-6 left-6 glass px-4 py-2 rounded-full text-xs">
                <Globe2 className="inline h-3 w-3 mr-1.5 text-primary" />
            ...
            <div>
              ...
              <h2 className="font-display text-4xl md:text-6xl font-bold leading-[1.05]">
                More than a fair.
                <br />
                <span className="text-gradient-brand">A destination.</span>
              </h2>
              <p className="text-muted-foreground mt-5 text-lg leading-relaxed">
                Plan your stay, discover restaurants and explore the cultural heart of northern
                Namibia. Lodging, transport and local experiences — curated for OATF visitors.
              </p>
      ...
      <section className="container-x py-24 md:py-32 border-t border-border">
        <div className="text-center mb-12">
          <div className="text-xs uppercase tracking-[0.3em] text-primary mb-3">Powered By</div>
          ...
          <div className="relative grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="font-display text-4xl md:text-5xl font-bold leading-[1.05]">
                Be part of OATF <span className="text-gradient-brand">2026.</span>
              </h2>
            ...
            <div className="flex flex-wrap md:justify-end gap-3">
              <Link
                to="/register"
                className="px-7 py-4 rounded-full bg-gradient-brand text-primary-foreground font-semibold shadow-elegant hover:scale-105 transition-transform inline-flex items-center gap-2"
              >
                Get your ticket <ArrowRight className="h-4 w-4" />
              </Link>
              <Link
                to="/exhibitors"
                className="px-7 py-4 rounded-full glass font-semibold hover:bg-white/10 transition-colors"
              >
                Become an exhibitor
              </Link>
            </div>
