...
export function SiteFooter() {
  return (
    <footer className="relative border-t border-border bg-ink mt-32">
      <div className="absolute inset-x-0 -top-px h-px bg-gradient-ember opacity-50" />
      <div className="container-x py-20">
        <div className="grid lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <div className="h-10 w-10 rounded-xl bg-gradient-ember" />
              <div className="font-display text-2xl font-bold">OATF</div>
            </div>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Ongwediva Annual Trade Fair. Hosted by Ongwediva Town Council.
          </p>
          <p className="text-xs text-muted-foreground">
